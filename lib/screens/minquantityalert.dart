...
class MinQuantityAlertScreen extends StatefulWidget {
  @override
  _MinQuantityAlertScreenState createState() => _MinQuantityAlertScreenState();
}

class _MinQuantityAlertScreenState extends State<MinQuantityAlertScreen> {
