...
class CustomeAddUpdate extends StatefulWidget {
  final String? customerId;

  const CustomeAddUpdate({Key? key, this.customerId}) : super(key: key);

  @override
  State<CustomeAddUpdate> createState() => _CustomeAddUpdateState();
}

class _CustomeAddUpdateState extends State<CustomeAddUpdate> {
  ...
  Future<void> uploadCustomerDetails() async {
    if (_formKey.currentState?.validate() ?? false) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Error uploading/updating customer details')),
        );
        print(error);
      }
    }
