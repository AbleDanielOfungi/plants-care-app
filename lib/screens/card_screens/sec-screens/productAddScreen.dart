...
class AddPopularProductScreen extends StatefulWidget {
  const AddPopularProductScreen({Key? key}) : super(key: key);

  @override
  _AddPopularProductScreenState createState() =>
      _AddPopularProductScreenState();
}
...
class _AddPopularProductScreenState extends State<AddPopularProductScreen> {
  ...
  // Product model
  XFile? _image;
  String _selectedCategory = 'Fertilizer Foilers';
  String _productName = '';
    ...
    if (_image != null) {
      ...
      await uploadTask.whenComplete(() async {
        try {
          ...
          setState(() {
            _image = null;
            _selectedCategory = 'Fertilizer Foilers';
  ...
  Map<String, String> categoryImages = {
    'Fertilizer Foilers': 'assets/logo.png',
    'Fertilizer Ganular': 'assets/logo.png',
    'Herbicides': 'assets/logo.png',
    'Fungicides': 'assets/logo.png',
    'Seeds': 'assets/logo.png',
    'Farm tools': 'assets/logo.png',
    ' Pesticides Medical Equipment': 'assets/logo.png',
  };
